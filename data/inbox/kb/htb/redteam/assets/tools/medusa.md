...
- example
    - ssh `medusa -h 192.168.0.100 -U usernames.txt -P passwords.txt -M ssh `
    - http multiple servers basic auth `medusa -H web_servers.txt -U usernames.txt -P passwords.txt -M http -m GET `
    - empty or default passwords `medusa -h 10.0.0.5 -U usernames.txt -e ns -M service_name`
    - 