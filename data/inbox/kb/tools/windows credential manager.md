...
![Credential Manager showing Windows and Generic Credentials with modification dates. No certificate-based credentials.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/308/img/CredMan_1.png)
