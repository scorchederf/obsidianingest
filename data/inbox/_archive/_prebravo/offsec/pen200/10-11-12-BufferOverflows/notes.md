...
- Process
  ...
  - Finding the offset
    ...
    ![immunity debugger EIP](_archive/_prebravo/offsec/pen200/10-11-12-BufferOverflows/image.png)
  ...
  - Overwrite the EIP
    ...
    ![immunity debugger EIP = 42424242 = BBBB](_archive/_prebravo/offsec/pen200/10-11-12-BufferOverflows/image-1.png)
  - Finding bad characters
    ...
    ![Right](_archive/_prebravo/offsec/pen200/10-11-12-BufferOverflows/image-2.png)
    ...
    ![Alt text](_archive/_prebravo/offsec/pen200/10-11-12-BufferOverflows/image-3.png)
  - Finding the right module
    ...
    ![Alt text](_archive/_prebravo/offsec/pen200/10-11-12-BufferOverflows/image-5.png)
    - we can see that essfunc.dll has all false protections on rebase, safeseh, aslr, mxcompat
    ![Alt text](_archive/_prebravo/offsec/pen200/10-11-12-BufferOverflows/image-6.png)
    ...
    - lets find occurences of \xff\xe4 in the module and get their address spaces
      ...
      ![Alt text](_archive/_prebravo/offsec/pen200/10-11-12-BufferOverflows/image-7.png)
