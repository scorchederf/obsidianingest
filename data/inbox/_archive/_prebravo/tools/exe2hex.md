...
embed into script
execute script on windows which will redirect to powershell and reassemble


```shell

#kali
#locate the netcat windows binary
kali@kali:~$ locate nc.exe | grep binaries
/usr/share/windows-resources/binaries/nc.exe

#copy to our working di
...
#convert the file to hex and instruct powershell.exe to assemble it back into binary using exe2hex
...
# windows
#copy to clipboard and paste all of nc.cmd to shell
# it will paste a huge amount.
![Alt text](exe2hex/image.png)
...
...
# we now have transfered netcat to the windows client
C:\Users\offsec> nc -h
[v1.10 NT]
