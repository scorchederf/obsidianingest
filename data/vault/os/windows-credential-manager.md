...
source: windows credential manager.md
related_tools:
- '[[cmdkey]]'
- '[[rundll32]]'
- '[[runas]]'
...
mitre_tactic: ''
mitre_technique: ''
real_path: C:\Windows\System32\cmdkey.exe
port: ''
protocol: ''
os: windows
---
...
![](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/308/img/CredMan_1.png)
...
![](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/308/img/CredMan_2.png)
...
![](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/308/img/CredMan_3.png)
